        ...
        <div class="dropdown-menu" aria-labelledby="navbarSummaryDropdown">
          {
            ...
            lib-view:build-href-subitem(lib-view:is-active("memprocsz-summary.xqy", $MODULE), "memprocsz-summary.xqy", lib-view:exec-query-get-uri("host-statuses", $START-TIME, $HOST), $START-TIME, $HOST, $DATABASE, "Memory Process Size Metrics"),
            ...
            lib-view:build-href-subitem(lib-view:is-active("page-in-summary.xqy", $MODULE), "page-in-summary.xqy", lib-view:exec-query-get-uri("host-statuses", $START-TIME, $HOST), $START-TIME, $HOST, $DATABASE, "Memory System Page In Metrics"),
